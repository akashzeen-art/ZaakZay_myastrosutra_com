...
export const generatePDFReport = async (
  ...
  pdf.text(
    "Generated by AI-Powered Mystical Insights",
    pageWidth / 2,
    footerY,
    { align: "center" },
  );
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-sm w-full">
      ...
      <div class="grid grid-cols-2 gap-3">
        <button onclick="window.open('https://twitter.com/intent/tweet?text=${shareText}', '_blank')" 
                class="flex items-center justify-center gap-2 p-3 bg-teal-500 text-white rounded-lg hover:bg-teal-600 transition-colors">
        ...
        <button onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=${shareUrl}&quote=${shareTitle}', '_blank')" 
                class="flex items-center justify-center gap-2 p-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <button onclick="window.open('https://www.linkedin.com/sharing/share-offsite/?url=${shareUrl}', '_blank')" 
                class="flex items-center justify-center gap-2 p-3 bg-teal-700 text-white rounded-lg hover:bg-teal-900 transition-colors">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
